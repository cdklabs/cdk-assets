...
> [!WARNING]
> This repository is for the deprecated V2 version of `cdk-assets`. The new
> V3 version of `cdk-assets` can be found here: [aws/aws-cdk-cli](https://github.com/aws/aws-cdk-cli/tree/main/packages/cdk-assets)
